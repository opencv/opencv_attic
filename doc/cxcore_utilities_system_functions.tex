...
OpenCV errors cause an cv.error exception.  For example:
...
OpenCV Error: Incorrect size of input array (Non-positive width or height) in cvCreateMatHeader, file /u/jamesb/opencv/trunk/opencv/src/cxcore/cxarray.cpp, line 113
Traceback (most recent call last):
  File "<stdin>", line 1, in <module>
