...
}{CPP}{FindCornerSubPix(image,corners,win,zero\_zone,criteria)-> corners}
...
}{CPP}{AdaptiveThreshold(src,dst,max\_value, adaptive\_method=CV\_ADAPTIVE\_THRESH\_MEAN\_C, threshold\_type=CV\_THRESH\_BINARY,block\_size=3,param1=5)-> None}
...
}{CPP}{CompareHist(hist1,hist2,method)->float}
