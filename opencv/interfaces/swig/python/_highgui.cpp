...
SWIGEXPORT void SWIG_init(void) {
  ...
  SWIG_Python_SetConstant(d, "CV_CAP_PROP_WHITE_BALANCE",SWIG_From_int(static_cast< int >(16)));
  SWIG_Python_SetConstant(d, "CV_CAP_PROP_RECTIFICATION",SWIG_From_int(static_cast< int >(17)));
