...
}\cvcodePy{CalcSubdivVoronoi2D(subdiv)-> None}
...
}\cvcodePy{ClearSubdivVoronoi2D(subdiv)-> None}
...
}\cvcodePy{CreateSubdivDelaunay2D(rect,storage)-> delaunay\_triangulation}
...
}\cvcodePy{FindNearestPoint2D(subdiv,pt)-> point}
...
}\cvcodePy{Subdiv2DEdgeDist(edge)-> point}
...
}\cvcodePy{Subdiv2DEdgeOrg(edge)-> point}
...
}\cvcodePy{Subdiv2DGetEdge(edge,type)-> CvSubdiv2DEdge}
\begin{lstlisting}
...
}\cvcodePy{Subdiv2DLocate(subdiv, pt) -> (loc, where)}
...
}\cvcodePy{Subdiv2DRotateEdge(edge,rotate)-> CvSubdiv2DEdge}
...
}\cvcodePy{SubdivDelaunay2DInsert(subdiv,pt)-> point}
