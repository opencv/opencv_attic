...
\cvdefC{void* cvLoad( \par const char* filename,\par CvMemStorage* memstorage=NULL,\par const char* name=NULL,\par const char** realName=NULL );}
\cvdefPy{Load(filename,memstorage=NULL,name=NULL)-> generic}
