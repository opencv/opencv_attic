...
}\cvdefPy{ArcLength(curve,slice=CV\_WHOLE\_SEQ,is\_closed=-1)-> double}
...
\cvdefCpp{void HuMoments( const Moments\& moments, double hu[7] );}
\begin{description}
