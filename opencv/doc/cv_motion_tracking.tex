...
}\cvdefPy{CalcGlobalOrientation(orientation,mask,mhi,timestamp,duration)-> None}
...
}\cvdefPy{CalcMotionGradient(mhi,mask,orientation,delta1,delta2,aperture\_size=3)-> None}
...
}\cvdefPy{CalcOpticalFlowBM(prev,curr,block\_size,shift\_size,max\_range,use\_previous,velx,vely)-> None}
...
}\cvdefPy{CalcOpticalFlowHS(prev,curr,use\_previous,velx,vely,lambda,criteria)-> None}
...
}\cvdefPy{CalcOpticalFlowLK(prev,curr,win\_size,velx,vely)-> None}
\begin{description}
