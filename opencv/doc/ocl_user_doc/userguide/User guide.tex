...
\end{itemize}
\begin{figure}[htbp]
\centerline{\includegraphics[width=1.89in,height=1.61in]{User1.eps}}
\label{fig1}
\end{figure}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=7.15in,height=5.94in]{User2.eps}}
\label{fig2}
\end{figure}

\begin{figure}[htbp]
\centerline{\includegraphics[width=2.38in,height=1.95in]{User3.eps}}
\label{fig3}
\end{figure}
$\begin{array}{l}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=5.55in,height=7.32in]{User4.eps}}
\label{fig4}
\end{figure}
