...
$\texttt{gamma\_grid.min\_val}*\texttt{gamma\_grid}$ step, \texttt{gamma\_grid.min\_val$*gamma\_grid.step^2$,...,} 
...
random sequential \href{#paper_backprop}{back-propagation algorithm}
and the second (default one) is batch \href{#paper_rprop}{RPROP algorithm}
