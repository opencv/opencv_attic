...
the C preprocessor (that erases all #defines).  Type information is missing, so
C code can't be generated for a generic language solution, so only python code is 
generated
"""
