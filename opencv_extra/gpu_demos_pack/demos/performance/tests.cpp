...
TEST(SURF)
{
    Mat src1 = imread("data/stereo_matching/aloeL.jpg", CV_LOAD_IMAGE_GRAYSCALE);
    Mat src2 = imread("data/stereo_matching/aloeR.jpg", CV_LOAD_IMAGE_GRAYSCALE);
...
TEST(Canny)
{
    Mat img = imread("data/stereo_matching/aloeL.jpg", CV_LOAD_IMAGE_GRAYSCALE);
