...
TEST(PackageManager, CheckVersionInstalled)
{
    ...
    PackageInfo info("2,3", PLATFORM_TEGRA3, 0);
    pm.InstalledPackages.push_back(info);
    EXPECT_TRUE(pm.CheckVersionInstalled("2.3", PLATFORM_TEGRA3, 0));
}
...
TEST(PackageManager, InstallVersion)
{
    ...
    PackageInfo info("2.3", PLATFORM_TEGRA3, 0);
    pm.InstalledPackages.push_back(info);
    EXPECT_TRUE(pm.InstallVersion("2.4", PLATFORM_TEGRA3, 0));
    EXPECT_EQ(2, pm.InstalledPackages.size());
    EXPECT_TRUE(pm.CheckVersionInstalled("2.4", PLATFORM_TEGRA3, 0));
}
...
TEST(PackageManager, GetPackagePathForArmv7)
{
    ...
    pm.InstalledPackages.push_back(info);
    string path = pm.GetPackagePathByVersion("2.3", PLATFORM_UNKNOWN, ARCH_ARMv7);
...
TEST(PackageManager, GetPackagePathForArmv7Neon)
{
    ...
    pm.InstalledPackages.push_back(info);
    string path = pm.GetPackagePathByVersion("2.3", PLATFORM_UNKNOWN, ARCH_ARMv7 | FEATURES_HAS_NEON);
...
{
    PackageManagerStub pm;
    PackageInfo info("2.3", PLATFORM_UNKNOWN, ARCH_X86);
    pm.InstalledPackages.push_back(info);
    string path = pm.GetPackagePathByVersion("2.3", PLATFORM_UNKNOWN, ARCH_X86);
...
TEST(PackageManager, GetPackagePathForX86SSE2)
{
    ...
    pm.InstalledPackages.push_back(info);
    string path = pm.GetPackagePathByVersion("2.3", PLATFORM_UNKNOWN, ARCH_X86 | FEATURES_HAS_SSE2);
...
{
    PackageManagerStub pm;
    PackageInfo info("2.4", PLATFORM_TEGRA2, 0);
    pm.InstalledPackages.push_back(info);
    string path = pm.GetPackagePathByVersion("2.4", PLATFORM_TEGRA2, 0);
...
TEST(PackageManager, GetPackagePathForTegra3)
{
    ...
    PackageInfo info("2.3", PLATFORM_TEGRA3, 0);
    pm.InstalledPackages.push_back(info);
    string path = pm.GetPackagePathByVersion("2.3", PLATFORM_TEGRA3, 0);
